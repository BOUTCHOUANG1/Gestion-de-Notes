...
public class ResponseMapper {
    ...
    public SubjectResponse toSubjectResponseBasic(Subject subject) {
        if (subject == null) return null;
        ...
        // Don't include teacher to avoid circular reference
        return response;
    }
    ...
    public TeacherResponse toTeacherResponseBasic(Teacher teacher) {
        ...
        if (teacher.getSubjects() != null && !teacher.getSubjects().isEmpty()) {
            try {
                List<SubjectResponse> subjectResponses = teacher.getSubjects().stream()
                    .map(this::toSubjectResponseBasic)
