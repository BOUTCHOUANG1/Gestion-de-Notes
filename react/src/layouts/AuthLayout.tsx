    ...
    return (
        <div>
            ...
            <section className={' w-screen h-screen bg-inherit flex items-center md:justify-center  '}>
                <div className={'shadow-2xl w-full 2xl:w-1/2 lg:w-3/4 md:h-[75%] h-[65%] flex items-center justify-center relative z-100 rounded-lg bg-bgColor border border-tertiary'}>
